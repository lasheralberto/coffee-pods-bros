...
export const TEXTS = {
  ...
  navbar: {
    ...
    startQuiz: { es: 'Mi café ahora', en: 'My coffee now' },
  ...
  cart: {
    ...
    annualSavings:      { es: 'Ahorro anual: {amount}', en: 'Annual savings: {amount}' },
  },

  /* ── Quiz Modal ── */
  quiz: {
    title: { es: '¿Qué café para este momento?', en: 'What coffee for this moment?' },
    description: {
      es: 'Tres señales rápidas y te recomendamos la taza exacta de ahora.',
      en: 'Three quick signals and we recommend the exact cup for now.',
    },
    introTitle: {
      es: 'Tu advisor diario de café',
      en: 'Your daily coffee advisor',
    },
    introSubtitle: {
      es: 'No es un onboarding: es una herramienta para afinar la taza según hora, estado y contexto.',
      en: 'This is not onboarding: it is a tool to tune the cup to your hour, state, and context.',
    },
    freeTextQuestion: {
    ...
    creatingProfile: {
      es: 'Guardando tu recomendación en el perfil...',
      en: 'Saving your recommendation to your profile...',
    },
    questionOf: { es: 'Pregunta', en: 'Question' },
    of: { es: 'de', en: 'of' },
    back: { es: 'Atrás', en: 'Back' },
    seeResult: { es: 'Ver recomendación', en: 'See recommendation' },
    next: { es: 'Siguiente', en: 'Next' },
    generating: { es: 'Buscando el café más preciso para ahora...', en: 'Finding the most precise coffee for right now...' },
  ...
  shop: {
    ...
    clearAllFilters: { es: 'Borrar filtros', en: 'Clear filters' },
  ...
  subscriptions: {
    ...
    startQuiz: { es: 'Descubrir café del momento', en: 'Discover coffee for now' },
  },
  ...
  quizQuestions: {
    q1: {
      question: {
        es: '¿En qué momento estás?',
        en: 'What part of the day are you in?',
      },
      subtitle: {
        es: 'Queremos afinar la taza para este tramo del día.',
        en: 'We want to tune the cup to this part of your day.',
      },
      earlyStart: { es: 'Arranque temprano', en: 'Early start' },
      earlyStartSub: { es: 'Primera taza del día', en: 'First cup of the day' },
      midMorning: { es: 'Media mañana', en: 'Mid-morning' },
      midMorningSub: { es: 'Necesito foco limpio', en: 'I need clean focus' },
      sobremesa: { es: 'Sobremesa', en: 'After lunch' },
      sobremesaSub: { es: 'Quiero alargar el momento', en: 'I want to stretch the moment' },
      afternoonReset: { es: 'Media tarde', en: 'Afternoon reset' },
      afternoonResetSub: { es: 'Busco volver al eje', en: 'I want to get back on track' },
      sunsetPause: { es: 'Atardecer tranquilo', en: 'Sunset pause' },
      sunsetPauseSub: { es: 'Más pausa que empuje', en: 'More pause than push' },
    },
    q2: {
      question: {
        es: '¿Qué necesitas de la taza?',
        en: 'What do you need from the cup?',
      },
      subtitle: {
        es: 'El estado manda más que la costumbre.',
        en: 'Your current state matters more than habit.',
      },
      needFocus: { es: 'Foco y claridad', en: 'Focus and clarity' },
      needFocusSub: { es: 'Quiero precisión mental', en: 'I want mental precision' },
      wantComfort: { es: 'Calma y abrigo', en: 'Comfort and calm' },
      wantComfortSub: { es: 'Busco una taza envolvente', en: 'I want an enveloping cup' },
      socialMoment: { es: 'Compartirlo', en: 'Share it' },
      socialMomentSub: { es: 'Una taza que abra conversación', en: 'A cup that opens conversation' },
      needReset: { es: 'Recolocarme', en: 'Reset myself' },
      needResetSub: { es: 'Necesito volver fresco', en: 'I need to come back fresh' },
      indulgentTreat: { es: 'Darme un gusto', en: 'Treat myself' },
      indulgentTreatSub: { es: 'Quiero algo con más placer', en: 'I want something more indulgent' },
    },
    q3: {
      question: {
        es: '¿Qué tipo de taza te apetece ahora?',
        en: 'What kind of cup do you want right now?',
      },
      subtitle: {
        es: 'No para siempre: solo para este momento.',
        en: 'Not forever, just for this moment.',
      },
      boldBody: { es: 'Intensa y con cuerpo', en: 'Bold and full-bodied' },
      boldBodySub: { es: 'Más profundidad que ligereza', en: 'More depth than lift' },
      balancedSweet: { es: 'Equilibrada y dulce', en: 'Balanced and sweet' },
      balancedSweetSub: { es: 'Caramelo, cacao, armonía', en: 'Caramel, cacao, harmony' },
      brightFruit: { es: 'Viva y afrutada', en: 'Bright and fruity' },
      brightFruitSub: { es: 'Más chispa y claridad', en: 'More sparkle and clarity' },
      milkFriendly: { es: 'Pensada para leche', en: 'Built for milk' },
      milkFriendlySub: { es: 'Que no se pierda con cremosidad', en: 'It should hold through creaminess' },
      surpriseMe: { es: 'Sorpréndeme', en: 'Surprise me' },
      surpriseMeSub: { es: 'Confío en la recomendación', en: 'I trust the recommendation' },
    },
    q4: {
      question: {
  ...
  quizAuthGate: {
    ...
    subtitle: { es: 'Regístrate para guardar esta recomendación contextual y volver a ella desde tu perfil.', en: 'Sign up to save this contextual recommendation and revisit it from your profile.' },
  },
  ...
  profile: {
    ...
    quizHeading:       { es: 'Tu café del momento', en: 'Your coffee for this moment' },
    ...
    takeQuiz:          { es: 'Encontrar mi café', en: 'Find my coffee' },
    ...
    refreshRecommendation: { es: 'Actualizar recomendación', en: 'Refresh recommendation' },
  },

  cafeMomento: {
    badge: { es: 'ADVISOR DIARIO', en: 'DAILY ADVISOR' },
    heading: { es: '¿Qué café para este momento?', en: 'What coffee for this moment?' },
    subtitle: {
      es: 'Responde con chips y te devolvemos la taza exacta de tu catálogo, con ritual y alternativas.',
      en: 'Answer with chips and we return the exact cup from your catalog, with ritual and alternatives.',
    },
    nowLabel: { es: 'Ahora mismo', en: 'Right now' },
    loading: { es: 'Afinando la recomendación...', en: 'Fine-tuning the recommendation...' },
    resultBadge: { es: 'RECOMENDACIÓN', en: 'RECOMMENDATION' },
    ritual: { es: 'Ritual', en: 'Ritual' },
    alternatives: { es: 'Alternativas', en: 'Alternatives' },
    restart: { es: 'Repetir advisor', en: 'Run advisor again' },
    cta: { es: 'Ver tienda completa', en: 'See full shop' },
  },
  ...
  personalPack: {
    ...
    retakeQuiz:        { es: 'Repetir quiz', en: 'Retake quiz' },
    noPackYet:         { es: 'Completa el quiz para recibir tu recomendación personalizada', en: 'Complete the quiz to get your personalized recommendation' },
    ...
    takeQuizCta:       { es: 'Descubre tu café', en: 'Discover your coffee' },
  ...
  userSubscription: {
    ...
    endsOn:            { es: 'Finaliza el', en: 'Ends on' },
    duration:          { es: 'Duración', en: 'Duration' },
    durationMonthly:   { es: 'Mensual', en: 'Monthly' },
    durationAnnual:    { es: 'Anual', en: 'Annual' },
    total:             { es: 'Total', en: 'Total' },
    items:             { es: 'Productos incluidos', en: 'Items included' },
    manageBtn:         { es: 'Gestionar suscripción', en: 'Manage subscription' },
    periodModalTitle:  { es: 'Elige la duración de tu suscripción', en: 'Choose your subscription term' },
    periodModalDescription: { es: 'Puedes suscribirte por un mes o por un año completo. En anual aplicamos un 15% de descuento en cada pack.', en: 'You can subscribe for one month or a full year. Annual billing applies a 15% discount to each pack.' },
    periodMonthly:     { es: 'Mensual', en: 'Monthly' },
    periodMonthlyHint: { es: 'Pago mes a mes, sin descuento adicional.', en: 'Pay month by month, with no additional discount.' },
    periodAnnual:      { es: 'Anual', en: 'Annual' },
    periodAnnualDiscount: { es: '-{percent}% en cada pack', en: '-{percent}% on every pack' },
    periodAnnualEquivalent: { es: 'Equivale a {price} al mes', en: 'Equivalent to {price} per month' },
    periodAnnualSavings: { es: 'Ahorras {amount} frente al pago mensual durante 12 meses', en: 'You save {amount} compared to paying monthly for 12 months' },
    periodSelectionSummary: { es: 'Resumen de cobro', en: 'Billing summary' },
    periodMonthlySummary: { es: 'Se te cobrará {price} por el próximo mes de suscripción.', en: 'You will be charged {price} for the next month of subscription.' },
    periodAnnualSummary: { es: 'Se te cobrará {price} por 12 meses de suscripción con descuento aplicado.', en: 'You will be charged {price} for 12 months of subscription with discount applied.' },
    periodConfirmCta:  { es: 'Continuar con esta suscripción', en: 'Continue with this subscription' },
  },
